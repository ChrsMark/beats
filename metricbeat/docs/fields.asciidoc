...
*`coredns.stats.dns.request.duration.sec`*::
+
--
type: long
...
*`coredns.stats.dns.request.size.bytes`*::
+
--
type: long
...
*`coredns.stats.dns.response.rcode`*::
+
--
type: keyword
...
*`coredns.stats.dns.request.family`*::
+
--
type: keyword
...
*`coredns.stats.dns.response.size.bytes`*::
+
--
type: long
