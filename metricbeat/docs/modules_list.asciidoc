...
|<<metricbeat-module-coredns,coredns>>  experimental[]   |image:./images/icon-no.png[No prebuilt dashboards]    |
.1+| .1+|  |<<metricbeat-metricset-coredns-stats,stats>> experimental[]
