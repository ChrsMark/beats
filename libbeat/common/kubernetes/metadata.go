...
type MetaGenerator interface {
	...
	ContainerMetadata(pod *Pod, containerName string, containerImage string) common.MapStr
}
...
// Containermetadata generates metadata for the given container of a pod
func (g *metaGenerator) ContainerMetadata(pod *Pod, containerName string, containerImage string) common.MapStr {
